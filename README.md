...
Vanilla JavaScript - Handles the interactive scrollspy navigation and theme toggling without the overhead of heavy frameworks.
...
Interactive Scrollspy Nav: The navigation bar automatically tracks the user's scroll position and highlights the active section in real-time.

Day/Night Mode: Includes a fully functional light/dark mode toggle that persists user preference via localStorage.

Mobile-First Responsive: Stacks seamlessly on mobile devices while expanding into a multi-column dashboard on desktop.
...
Email: srishtilohanisharma@gmail.com

Designed & coded for the cloud. Single-file deploy ready.
